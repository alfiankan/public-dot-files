" vim-bootstrap 2022-05-06 00:58:53
...
let g:vim_bootstrap_langs = "c,elixir,erlang,go,haskell,html,javascript,lua,php,python,ruby,rust,scala,typescript"
...
command! Dba execute '%bdelete|edit#|bdelete#'
